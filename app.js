...
// $('img[usemap]').maphilight()
  ...
  var game = {
    ...
    $territories: $('.countries'), //fisher yates
    $territories_Obj: { $indonesia: $('.indonesia').first(),
...
// While there remain elements to shuffle…
  ...
  game.$start_game.on('click',function(){
    for (territory in game.$territories_Obj){
      game.$territories_Arr.push(game.$territories_Obj[territory]);
    }
    console.log('array exists')
    shuffle(game.$territories_Arr);
    console.log('array shuffled');
    for (var i = 0; i<game.$territories_Arr.length; i++) {
    game.$player1Territories.push(game.$territories_Arr);
    console.log('player1', game.$player1Territories)
  }
  game.$player2Territories.push(game.$player1Territories.splice(0, 21));
  ...
  console.log('game.$territories_Obj',game.$territories_Obj)
